...
|           a| image::https://img.shields.io/badge/Code-V1-red.svg[]        |https://github.com/IUT-Blagnac/sae2023-bank-3b1/releases/tag/V1
|           a| image::https://img.shields.io/badge/JAR-V1-red.svg[]        |
|           a| image::https://img.shields.io/badge/JavaDoc-V1-red.svg[]        |
|           | Suivi projet V1   |
